        ...
        <div className="w-full space-y-4 md:space-y-6 lg:space-y-8" data-oid="0:j1uqz">
            ...
            >
                ...
                <div className="space-y-3 md:space-y-4" data-oid="omb_hjo">
                    ...
                    <div
                        className="flex items-start space-x-3 md:space-x-4 p-3 md:p-4 bg-green-50 rounded-lg"
                        data-oid="yjwxuv7"
                    >
                        <div
                            className="w-8 h-8 md:w-10 md:h-10 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0"
                            data-oid="j2nv4_n"
                        >
                            <svg
                        ...
                        <div className="flex-1 min-w-0" data-oid="fj7nhcu">
                            <p
                                className="text-sm md:text-base text-gray-900 font-medium"
                                data-oid="m6mmp2y"
                            >
                                Prescription RX-001 processed
                            </p>
                            <p className="text-xs md:text-sm text-gray-600" data-oid="p200b-f">
                                Dr. Ahmed Hassan - 3 medicines
                            </p>
                            <p className="text-xs text-gray-500" data-oid="o5d58dx">
                                1 day ago
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        className="flex items-start space-x-3 md:space-x-4 p-3 md:p-4 bg-purple-50 rounded-lg"
                        data-oid="-5aqgcb"
                    >
                        <div
                            className="w-8 h-8 md:w-10 md:h-10 bg-purple-100 rounded-full flex items-center justify-center flex-shrink-0"
                            data-oid="lg3-o4g"
                        >
                            <svg
                        ...
                        <div className="flex-1 min-w-0" data-oid="z:aizqh">
                            <p
                                className="text-sm md:text-base text-gray-900 font-medium"
                                data-oid="2ag0onf"
                            >
                            ...
                            <p className="text-xs md:text-sm text-gray-600" data-oid="x68b6e6">
                                Monthly Vitamins Package
                            </p>
                            <p className="text-xs text-gray-500" data-oid="nxwqq:d">
                                3 days ago
                            </p>
                        </div>
                    </div>
