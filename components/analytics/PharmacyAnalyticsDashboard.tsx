...
export function PharmacyAnalyticsDashboard() {
    ...
    const getAnalyticsData = (timeframe: string): AnalyticsData => {
        ...
        return {
            ...
            inventory: {
                ...
                categories: [
                    { name: 'Pain Relief', value: 245, color: BRAND_CHART_COLORS.primary },
                    { name: 'Antibiotics', value: 189, color: BRAND_CHART_COLORS.secondary },
                    { name: 'Vitamins', value: 156, color: BRAND_CHART_COLORS.success },
                    { name: 'Heart Medicine', value: 134, color: BRAND_CHART_COLORS.info },
                    { name: 'Others', value: 523, color: BRAND_CHART_COLORS.accent },
                ],
            },
            customers: {
    ...
    const lowStockItems = [
        { name: 'Paracetamol 500mg', stock: 5, minStock: 20, category: 'Pain Relief' },
        { name: 'Amoxicillin 250mg', stock: 8, minStock: 15, category: 'Antibiotics' },
        { name: 'Vitamin D3', stock: 3, minStock: 10, category: 'Vitamins' },
        { name: 'Blood Pressure Monitor', stock: 2, minStock: 5, category: 'Medical Devices' },
    ];
            ...
            <div className="flex items-center justify-between" data-oid="232k8rq">
                <div data-oid="i:q_6vg">
                    ...
                    <p className="text-muted-foreground" data-oid="t_e4voc">
                        Comprehensive insights into pharmacy performance and operations
                    </p>
                </div>
